...
# weights parameter removed since we are working with mixed data (see eqn 10 of paper)
MAE <- function(true_shapley, shapley_method, N_test){
  mean(colSums((abs(true_shapley - shapley_method)))[-1])/N_test
  # mean(apply(), 2, sum)[-1])
}
